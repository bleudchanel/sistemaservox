...
Public Class frmMantenimientoComisiones
...
#End Region
    ...
    'Private Sub btnDesactivar_Click(sender As System.Object, e As System.EventArgs)
    '    If Me.dgvProducto.CurrentRow IsNot Nothing AndAlso Me.dgvProducto.Rows.Count > 0 Then
    ...
    Private Sub btnBuscarProveedor_Click(sender As System.Object, e As System.EventArgs)
    ...
    'Private Sub chkMostrarControlesAvanzados_CheckedChanged(sender As System.Object, e As System.EventArgs)
    ...
    'Private Sub btnNuevoPS_Click(sender As System.Object, e As System.EventArgs)
    '    Dim ObjFrmHijo As New frmMantenimientoProveedor
    '    'ObjFrmHijo.pFormularioPadrePTA = Me.Name
    '    'ObjFrmHijo.bolEsBusqueda = True
    '    'ObjFrmHijo.Owner = Me
    ...
    'Private Sub btnEliminarPS_Click(sender As System.Object, e As System.EventArgs)
    ...
    'Private Sub btnVerOperacion_Click(sender As System.Object, e As System.EventArgs)
    ...
    Private dtResultadoActual As New DataTable
    Private Sub btnGenerarHistorial_Click(sender As System.Object, e As System.EventArgs) Handles btnGenerarHistorial.Click
        ...
        dtResultadoActual = New DataTable
        Dim Empleado As New clsEmpleadoBUS
        dtResultadoActual = Empleado.fncHistorialEmpleadoBUS(-1, Me.cmbMes.SelectedValue, Me.cmbAnio.SelectedValue)
        If fncValidaDataTable(dtResultadoActual) Then
            fncSetDataTableInDGV(dtResultadoActual, dgvHistorialComisiones)
        End If
    End Sub

    Private Sub btnExcel_Click_1(sender As System.Object, e As System.EventArgs) Handles btnExcel.Click
        If fncValidaDataTable(dtResultadoActual) Then
            FncDataTable2Excel(dtResultadoActual, "Historial")
        End If
    End Sub
End Class