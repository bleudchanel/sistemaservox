...
Public Class frmMantenimientoComprasSinIGV
...
#End Region
    ...
    Sub LlenarDatosPorOrdenCompra(ByVal intIdCompraActual As Integer, ByVal intOrden As Integer, ByVal intAnioPeriodo As Integer)
        ...
        Dim Compra As New clsCompraBUS
        '' Dim DetalleCompra As New clsDetalleCompraBUS
        Dim dtBase As DataTable() = Compra.fncComprasPorOrden(enmTipoInterno.CompraSinIGV, intAnioPeriodo, , "1", intOrden, intIdCompraActual)
        If fncValidaDataTable(dtBase(0)) Then
    ...
    Private Sub btnConfirmarProducto_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfirmarProducto.Click
        ...
        Else
            ...
            Else
                ...
                Dim Producto As New clsProductoBUS
                Dim dtPrecio As DataTable = Producto.fncObtenerPrecioCostoActualProducto(intIdProducto, True)
    ...
    Sub SeleccionaProducto()
        With Me.dgvProducto.CurrentRow
            ...
            bolPivot = True
            Me.txtCosto.Text = fncForzarDecimal(.Cells("subCosteSinIGV").Value)
    ...
    Private Sub btnBuscarFactura_Click(sender As System.Object, e As System.EventArgs) Handles btnBuscarFactura.Click
        ...
        ObjFrmHijo.intIdIdentificador = enmTipoInterno.CompraSinIGV  'Compra Sin IGV
        ObjFrmHijo.ActiveControl = ObjFrmHijo.txtNumero
        ObjFrmHijo.intIdTipoInterno = enmTipoInterno.CompraSinIGV
        If ObjFrmHijo.ShowDialog = Windows.Forms.DialogResult.OK Then
    ...
    Private Sub nudCantidad_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles nudCantidad.KeyDown
        If e.KeyCode = Keys.Enter Or e.KeyCode = Keys.Down Then
            Me.ActiveControl = Me.txtCosto
            Me.txtCosto.Select(0, txtCosto.Text.Length)
        ElseIf e.KeyCode = Keys.Up Then
            If Me.txtDescripcionProducto.Enabled = True Then
                Me.ActiveControl = Me.txtDescripcionProducto
                Me.txtDescripcionProducto.Select(0, txtDescripcionProducto.Text.Length)
    ...
    Private Sub txtCosto_TextChanged_1(sender As System.Object, e As System.EventArgs) Handles txtCosto.TextChanged
        If bolPivot = True Then
            Dim decCostoUnitarioSinIGV As Decimal = (fncForzarDecimal(Me.txtCosto.Text))
            Dim decCostoUnitarioConIGV As Decimal = (decCostoUnitarioSinIGV * (1 + decIGVCompra))
    ...
    Private Sub txtCostoConIGV_TextChanged_1(sender As System.Object, e As System.EventArgs) Handles txtCostoConIGV.TextChanged
        ...
        '    Dim decCostoUnitarioConIGV As Decimal = fncRound4(fncForzarDecimal(Me.txtCostoConIGV.Text))
        '    Dim decCostoUnitarioSinIGV As Decimal = fncRound4(decCostoUnitarioConIGV / (1 + decIGVCompra))
    ...
    Private Sub txtCostoConIGV_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles txtCostoConIGV.KeyDown
        ...
        ElseIf e.KeyCode = Keys.Escape Then
            ...
            '    nudCantidad.Select(0, nudCantidad.Text.Length)
        ElseIf e.KeyCode = Keys.Up Then
            Me.ActiveControl = txtCosto
            txtCosto.Select(0, txtCosto.Text.Length)
        End If
    End Sub
    ...
    Private Sub btnBuscarProveedorTransporte_Click(sender As System.Object, e As System.EventArgs) Handles btnBuscarProveedorTransporte.Click
        If Me.intIdCompra = 0 Then
    ...
    Private Sub btnLimpiarTransporte_Click(sender As System.Object, e As System.EventArgs) Handles btnQuitarTransporte.Click
        Dim Compra As New clsCompraBUS
        If intIdCompra > 0 Then
    ...
    Private Sub frmMantenimientoComprasSinIGV_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Add Then
            Me.btnAgregarDetalle.PerformClick()
    ...
    Private Sub txtTotalSinIGV_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtTotalSinIGV.TextChanged
        If bolPivot = False Then
            Dim decPrecioUnidad As Decimal = fncRound2(fncForzarDecimal(Me.txtTotalSinIGV.Text) / If(fncForzarDecimal(nudCantidad.Text) > 0, fncForzarDecimal(nudCantidad.Text), 1))
            Me.txtCosto.Text = FormatearNumero(decPrecioUnidad, 2)
            ...
            Dim decCostoTotalSinIGV As Decimal = fncRound2(fncForzarDecimal(Me.txtTotalSinIGV.Text)) 'fncRound2(decCostoUnitarioSinIGV * fncForzarDecimal(nudCantidad.Text))
            Dim decCostoTotalConIGV As Decimal = fncRound2(decCostoTotalSinIGV * (1 + decIGVCompra))
            Dim decCostoTotalIGV As Decimal = fncRound2(decCostoTotalConIGV - decCostoTotalSinIGV)
    ...
    Private Sub txtTotalSinIGV_Enter(sender As System.Object, e As System.EventArgs) Handles txtTotalSinIGV.Enter
        bolPivot = False
    End Sub
End Class