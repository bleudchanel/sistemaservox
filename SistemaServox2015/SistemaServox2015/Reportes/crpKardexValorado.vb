...
Public Class crpKardexValorado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaServox2015.crpKardexValorado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpKardexValorado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpKardexValorado = New crpKardexValorado()
        rpt.Site = Me.Site
        Return rpt
    End Function
