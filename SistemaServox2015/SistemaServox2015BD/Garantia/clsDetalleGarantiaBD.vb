...
Public Class clsDetalleGarantiaBD
    Inherits clsDetalleGarantiaBN
...
#Region "Mantenimiento Básico"
    Function fncRegistrarBD() As Integer
        Dim rs As Integer = -1
        Try
            Dim Comando As Common.DbCommand = db.GetStoredProcCommand("usp_Pln_I_srv_DetalleGarantia")
            db.AddOutParameter(Comando, "@IdDetalleGarantia", DbType.Int64, IdDetalleGarantia)
            ...
            db.AddInParameter(Comando, "@ObservacionDetalle", DbType.String, ObservacionDetalle)
            rs = db.ExecuteNonQuery(Comando)
            IdDetalleGarantia = db.GetParameterValue(Comando, "@IdDetalleGarantia")
    ...
    Function fncModificarBD() As Integer
        Dim rs As Integer = -1
        Try
            Dim Comando As Common.DbCommand = db.GetStoredProcCommand("usp_Pln_U_srv_DetalleGarantia")
            db.AddInParameter(Comando, "@IdDetalleGarantia", DbType.Int64, IdDetalleGarantia)
            db.AddInParameter(Comando, "@IdGarantia", DbType.Int64, IdGarantia)
            db.AddInParameter(Comando, "@Estado", DbType.Int64, Estado)
            db.AddInParameter(Comando, "@IdProducto", DbType.Int64, IdProducto)
            db.AddInParameter(Comando, "@Cantidad", DbType.Double, Cantidad)
    ...
    Function fncEliminarBD() As Integer
        Dim rs As Integer = -1
        Try
            Dim Comando As Common.DbCommand = db.GetStoredProcCommand("usp_Pln_D_srv_DetalleGarantia")
            db.AddInParameter(Comando, "@IdDetalleGarantia", DbType.Int64, IdDetalleGarantia)
            rs = db.ExecuteNonQuery(Comando)
        Catch ex As Exception
            NotificarError(ex)
    ...
    Optional IdDetalleGarantia As Integer = -1 _
        ...
        Try
            Dim Comando As Common.DbCommand = db.GetStoredProcCommand("usp_Pln_S_srv_DetalleGarantia")
            db.AddInParameter(Comando, "@IdDetalleGarantia", DbType.Int64, IdDetalleGarantia)
            Dim Consulta As New DataSet
            db.LoadDataSet(Comando, Consulta, New String() {"usp_Pln_S_srv_DetalleGarantia"})
...
#End Region
    ...
    Public Function fncusp_Srv_ListarDetallePorGarantiaBD( _
Optional IdGarantia As Integer = -1 _
) As DataTable
        Dim rs As New DataTable
        Try
            Dim Comando As Common.DbCommand = db.GetStoredProcCommand("usp_Srv_ListarDetallePorGarantia")
            db.AddInParameter(Comando, "@IdGarantia", DbType.Int64, IdGarantia)
            Dim Consulta As New DataSet
            db.LoadDataSet(Comando, Consulta, New String() {"usp_Srv_ListarDetallePorGarantia"})
            rs = Consulta.Tables(0)
        Catch ex As Exception
            NotificarError(ex)
        End Try
